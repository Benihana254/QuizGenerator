...
for quizNum in range(35):
    ...
    with open(f'capitals_quiz_{quizNum+ 1}.txt', 'w') as quiz_file, \
         open(f'capitals_answer_{quizNum + 1}.txt', 'w') as  answer_key:
                ...
                for question_num in range(50):
                    ...
                    # quiz_file.close()
                    # answer_key.close() With kw ensures closing automatiaclly
